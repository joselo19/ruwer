            ...
            <!-- Botón Nuevo  PDF-->
                <div>
                    ...
                    <div class="row text-center hidden-xs">
                        <a href="index.php?accion=nuevo-pdf"  class="btn btn-primary" title = "Nuevo PDF">
            ...
            <!--Eliminando Registros -->
                        <?php
                            ...
                            if(isset($_GET['delete'])){
                                ...
                                // seleciona a imagem
                                $seleciona = "SELECT * from archivos_pdf WHERE id_archivo= :id_delete";
                                ...
                                try{
                                    ...
                                    if($contar > 0){   
                                        ...
                                        $archivoDelet = $exibir['archivo_pdf'];
                                        $arquivo = "../pdf/" .$archivoDelet;
                                        unlink($arquivo); //elimina archivo PDF  


                                        $seleciona = "DELETE from archivos_pdf WHERE id_archivo=:id_delete";
                                        try{
                                            $result = $conexion->prepare($seleciona);
                                            $result->bindParam('id_delete',$id_delete, PDO::PARAM_INT);             
                                            $result->execute();
                                            ...
                                            if($contar>0){
                                                echo '<div class="alert alert-success">
                                                            ...
                                                            <strong>Exito!</strong> El Archivo PDF fue eliminado.
                                                      </div>';
                                            }else{
                                                echo '<div class="alert alert-danger">
                                                            <button type="button" class="close" data-dismiss="alert">×</button>
                                                            <strong>Error</strong> No fue posible eliminar éste Archivo PDF.
                                                      </div>';    
                                            }
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <!--Cabecera de la Tabla-->
                                <div class="x_title">
                                    <h2>Listado de Archivos PDF <small></small></h2>
                                                ...
                                                ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="td-actions text-center">
                                                                        <a href="index.php?accion=editar-pdf&id=<?php echo $mostrar->id_archivo;?>" class="btn btn-small btn-success" title = "Click para Editar">
                                                                            <i class="glyphicon glyphicon-pencil"> </i>
                                                                        </a>

                                                                        <a href="#ver-registro<?php echo $mostrar->id_archivo;?>" class="btn btn-small btn-info" data-toggle="modal" title = " Click para Visualizar">
                                                                            <i class="glyphicon glyphicon-eye-open"> </i>
                                                                        </a>
                                                                                                                                                                        
                                                                        <a href="#eliminar-registro<?php echo $mostrar->id_archivo;?>" class="btn btn-small btn-danger" data-toggle="modal" title = " Click para Eliminar">
                                                                ...
                                                                <!-- Ver Registro-->
                                                                    <div class="modal fade" id="ver-registro<?php echo $mostrar->id_archivo;?>">
                                                                                ...
                                                                                <!-- Contenido de la Ventana -->
                                                                                    <div class="modal-body text-justify">
                                                                                        ...
                                                                                        <div class="text-center">
                                                                                            <a href="../pdf/archivos-pdf.php?pdf_archivo=<?php echo $mostrar->archivo_pdf;?>" class="btn btn-small btn-info" title = "Click para Visualizar" target="_blank">
                                                                                                <i class="glyphicon glyphicon-eye-open"></i>
                                                                                                <span> Ver PDF</span>
                                                                                            </a> 
                                                                                        </div>
                                                                ...
                                                                <!-- Ventana para Eliminar-->
                                                                    <div class="modal fade" id="eliminar-registro<?php echo $mostrar->id_archivo;?>">
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <!-- Header de la Ventana -->
                                                                                    <div class="modal-header text-center">
                                                                                ...
                                                                                <!-- Contenido de la Ventana -->
                                                                                    <div class="modal-body text-justify">
                                                                                        <p>
                                                                                            ...
                                                                                            Quieres <strong>ELIMINAR</strong> el Archivo:
                                                                                            <?php echo $mostrar->titulo_archivo; ?>
                                                                                        </p>
                                                                                    </div>
                                                                                <!-- /Contenido de la Ventana -->
                                                                                ...
                                                                                <!-- Footer de la Ventana -->
                                                                                    <div class="modal-footer">
                                                                                        <div class="text-center"> 
                                                                                            ...
                                                                                            <a href="index.php?accion=pdf&delete=<?php echo $mostrar->id_archivo;?>" class="btn btn-danger" title="Si">
